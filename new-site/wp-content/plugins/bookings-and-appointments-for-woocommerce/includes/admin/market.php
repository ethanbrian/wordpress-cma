...
<div class="box14 table-box-main">
    ...
    <br />
    <center>
        <a href="https://www.pluginhive.com/product/woocommerce-booking-and-appointments/" target="_blank" class="button button-primary"><?php echo __('Upgrade to Premium','bookings-and-appointments-for-woocommerce');?></a> 
        <a href="https://woocommercebookings.pluginhive.com/shop" target="_blank" class="button button-primary"><?php echo __('Live Demo' , 'bookings-and-appointments-for-woocommerce');?></a>

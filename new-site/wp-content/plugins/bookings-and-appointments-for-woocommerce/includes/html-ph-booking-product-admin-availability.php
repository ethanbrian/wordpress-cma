...
<div id='booking_availability' class='panel woocommerce_options_panel'>
	...
	<div class="" id="availability_wraper">
		...
		<div class="nonworking-wraper non-working-hours">
			<p class="form-field" >
				<label class="nonworking-title" style="width:30%"><?php _e('Non-working hours (All days)', 'bookings-and-appointments-for-woocommerce') ?></label>
				...
				<br>
				<i><?php
				echo  __("Appointments within this period will appear blocked on the calendar.",'bookings-and-appointments-for-woocommerce') ?>
				</i>
			</p>
		</div>
		<div class="nonworking-wraper">
			<p class="form-field" >
				<label class="nonworking-title" style="width:30%"><?php _e('Non-working days (Weekend)','bookings-and-appointments-for-woocommerce') ?></label>
				<span><input type="checkbox" name="holiday_saturday" value="yes" <?php if( isset($rule['holiday_saturday']) && $rule['holiday_saturday']=='yes' ) echo "checked";?> > <?php _e('Saturday','bookings-and-appointments-for-woocommerce') ?></span>
		  		...
		  		<br>
				<i><?php
				echo  __("If checked, these days would appear blocked on the calendar.",'bookings-and-appointments-for-woocommerce') ?>
				</i>
			</p>
		</div>
	</div>

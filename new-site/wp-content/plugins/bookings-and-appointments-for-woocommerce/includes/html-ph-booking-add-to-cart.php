...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" action="<?php echo esc_url( get_permalink() ); ?>" method="post" enctype='multipart/form-data'>
		...
		<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button alt disabled ph_bookings_book_now_button"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>

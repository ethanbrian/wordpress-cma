	...
	class SP_EAP_Options extends SP_EAP_Abstract {
		...
		public function add_options_html() {
			...
			if ( $show_buttons ) {
				...
				echo '<input type="submit" name="' . esc_attr( $this->unique ) . '[_nonce][save]" class="button button-primary eapro-top-save eapro-save' . esc_attr( $ajax_class ) . '" value="' . esc_html__( 'Save', 'easy-accordion-pro' ) . '" data-save="' . esc_html__( 'Saving...', 'easy-accordion-pro' ) . '">';
				echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="eapro_transient[reset_section]" class="button button-secondary eapro-reset-section eapro-confirm" value="' . esc_html__( 'Reset Section', 'easy-accordion-pro' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'easy-accordion-pro' ) . '">' : '';
				echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="eapro_transient[reset]" class="button eapro-warning-primary eapro-reset-all eapro-confirm" value="' . esc_html__( 'Reset All', 'easy-accordion-pro' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all options?', 'easy-accordion-pro' ) . '">' : '';
				echo '</div>';
			}
			echo '</div>';

 ...
 * 
 * @class SUMOSubscriptions_Upgrade_Or_Downgrade_Tab
 */
class SUMOSubscriptions_Upgrade_Or_Downgrade_Tab extends SUMO_Abstract_Subscription_Settings {

	/**
	 * SUMOSubscriptions_Upgrade_Or_Downgrade_Tab constructor.
	 */
...
return new SUMOSubscriptions_Upgrade_Or_Downgrade_Tab() ;

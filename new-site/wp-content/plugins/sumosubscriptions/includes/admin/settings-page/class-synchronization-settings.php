	...
	public function get_settings() {
		...
		return apply_filters( 'sumosubscriptions_get_' . $this->id . '_settings', array(
			...
			array(
				...
				'desc_tip' => __( 'If you need to charge the renewal on a specific date of the month  then, select "Exact Date/Day" option. If you need to charge the renewal on a specific date without considering the month then, select â€œFirst Occurrenceâ€? option.', 'sumosubscriptions' ),
			),
			array(

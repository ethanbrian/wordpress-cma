...
class SUMOSubscriptions_My_Account_Settings extends SUMO_Abstract_Subscription_Settings {
	...
	public function custom_types_save( $posted ) {
		if ( isset( $posted[ 'sumo_subscription_pause_by_user_filter' ] ) ) {
			update_option( 'sumo_subscription_pause_by_user_filter', ! is_array( $posted[ 'sumo_subscription_pause_by_user_filter' ] ) ? array_filter( array_map( 'absint', explode( ',', $posted[ 'sumo_subscription_pause_by_user_filter' ] ) ) ) : $posted[ 'sumo_subscription_pause_by_user_filter' ]  ) ;
		}
		if ( isset( $posted[ 'sumo_subscription_cancel_by_user_filter' ] ) ) {
			update_option( 'sumo_subscription_cancel_by_user_filter', ! is_array( $posted[ 'sumo_subscription_cancel_by_user_filter' ] ) ? array_filter( array_map( 'absint', explode( ',', $posted[ 'sumo_subscription_cancel_by_user_filter' ] ) ) ) : $posted[ 'sumo_subscription_cancel_by_user_filter' ]  ) ;
		}
		if ( isset( $posted[ 'sumo_subscription_cancel_by_product_filter' ] ) ) {
			update_option( 'sumo_subscription_cancel_by_product_filter', ! is_array( $posted[ 'sumo_subscription_cancel_by_product_filter' ] ) ? array_filter( array_map( 'absint', explode( ',', $posted[ 'sumo_subscription_cancel_by_product_filter' ] ) ) ) : $posted[ 'sumo_subscription_cancel_by_product_filter' ]  ) ;
		}
	}

<div class=" welcome_page">
	<div class="welcome_header" > 
		<div class="welcome_title" >
			<h1>Welcome to <strong>SUMO Subscriptions</strong></h1>
		</div>
		<div class="branding_logo" >
			<a href="http://fantasticplugins.com/" target="_blank" ><img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/Fantastic-Plugins-final-Logo.png" alt="" /></a>
		</div>
	</div> 

	<p>
		Thanks for installing SUMO Subscriptions...
	</p>

	<div class="welcomepage_tab">
		<ul>
			<li><a href="#compatibleplugins" class="tab_3 active_welcome">Compatible Plugins</a></li>
			<li><a href="#ourotherplugins" class="tab_2">Our Other Plugins</a></li> 
		</ul>        
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=sumosubs-settings' ) ) ; ?>" class="admin_btn" >Go to Settings</a>        
		<a href="http://fantasticplugins.com/support/" class="support_btn" target="_blank" >Contact Support</a>        
	</div>
	<!--            about SUMO Subscriptions tab content      -->

	<!--            compatibility tab content      -->    
	<div class="con_3">
		<div class="Brand_featured">
			<h2>SUMO Subscriptions is Compatible with</h2>
			<div class="feature">
				...
				<div class="two_fet_img">
					<a href="https://codecanyon.net/item/sumo-memberships-woocommerce-membership-system/16642362?ref=FantasticPlugins" target="_blank" >
						<div class="Brand_1">
							<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/sumo_membership.png" alt=""/>
							<div class="hide">
					...
					<a href="https://codecanyon.net/item/sumo-donations-woocommerce-donation-system/12283878?ref=FantasticPlugins" target="_blank" >
						<div class="Brand_1">
							<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/sumo_donation.png" alt=""/>
							<div class="hide">
				...
				<div class="two_fet_img">
					<a href="https://codecanyon.net/item/sumo-reward-points-woocommerce-reward-system/7791451?ref=FantasticPlugins" target="_blank" >
						<div class="Brand_1">
							<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/sumo_reward_points.png" alt=""/>
							<div class="hide">
					...
					<a href="https://codecanyon.net/item/sumo-affiliates-woocommerce-affiliate-system/18273930?ref=FantasticPlugins" target="_blank" >
						<div class="Brand_1">
							<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/sumo_affiliates.png" alt=""/>
							<div class="hide">
		...
		<div class="feature">
			<div class="two_fet_img">
				<a href="https://codecanyon.net/item/woocommerce-recover-abandoned-cart/7715167?ref=FantasticPlugins" target="_blank" >
					<div class="Brand_1">
						<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/Recover_abandoned_cart.png" alt=""/>
						<div class="hide">
				...
				<a href="https://codecanyon.net/item/sumo-coupons-woocommerce-coupon-system/16082070?ref=FantasticPlugins" target="_blank" >
					<div class="Brand_1">
						<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/sumo_coupons.png" alt=""/>
						<div class="hide">
							<h4>SUMO Coupons</h4>
						</div>
						<div class="description_adv">
			...
			<div class="two_fet_img">
				<a href="https://codecanyon.net/item/woocommerce-pay-your-price/7000238?ref=FantasticPlugins" target="_blank" >
					<div class="Brand_1">
						<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/pay_your_price.png" alt=""/>
						<div class="hide">
				...
				<a href="https://codecanyon.net/item/galaxy-funder-woocommerce-crowdfunding-system/7360954?ref=FantasticPlugins" target="_blank" >
					<div class="Brand_1">
						<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/Galaxy_funder.png" alt=""/>
						<div class="hide">
							<h4>Galaxy Funder</h4>
						</div>
						<div class="description_adv">
			...
			<div class="feature">
				<div class="two_fet_img">
					...
					<a href="https://codecanyon.net/item/universe-funder-woocommerce-crowdfunding-system/10283380?ref=FantasticPlugins" target="_blank" >
						<div class="Brand_1">
							<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/Universe_Funder.png" alt=""/>
							<div class="hide">
					...
					<a href="https://codecanyon.net/item/woocommerce-paypal-adaptive-split-payment/7948397?ref=FantasticPlugins" target="_blank" >
						<div class="Brand_1">
							<img src="<?php echo esc_url( WP_PLUGIN_URL ) ; ?>/sumosubscriptions/assets/images/paypal_adaptive_split_payment.png" alt=""/>
							<div class="hide">

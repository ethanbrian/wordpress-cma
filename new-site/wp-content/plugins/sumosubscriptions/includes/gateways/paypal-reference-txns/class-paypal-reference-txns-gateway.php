...
class SUMO_Paypal_Reference_Txns_Gateway extends WC_Payment_Gateway {
	...
	/**
	 * SUMO_Reference_Txns_Subscription_Handler
	 * 
	 * @var object 
	 */
		...
		<tr>
			...
			<td>
				<div class='logo-preview-wrapper'>
					...
					<input type="button" id="upload_logo_button" data-choose="<?php esc_attr_e( 'Choose a Logo', 'sumosubscriptions' ) ; ?>" data-update="<?php esc_attr_e( 'Add Logo', 'sumosubscriptions' ) ; ?>" data-saved_attachment="<?php echo esc_attr( $attachment_id ) ; ?>" class="button" value="<?php esc_html_e( 'Upload Logo', 'sumosubscriptions' ) ; ?>" />

					<?php if ( $attachment_id ) : ?>
						<input type="submit" name="delete_logo" class="button" value="<?php esc_html_e( 'Delete Logo', 'sumosubscriptions' ) ; ?>" />
					<?php endif ; ?>
				</div>
			</td>
		</tr>
	...
	public function save_data( $posted ) {
		if ( isset( $_REQUEST[ 'logo_attachment_id' ] ) && isset( $posted[ 'page_logo' ] ) ) {
			$posted[ 'page_logo' ] = wc_clean( wp_unslash( $_REQUEST[ 'logo_attachment_id' ] ) ) ;
		}

		if ( isset( $_REQUEST[ 'delete_logo' ] ) && isset( $posted[ 'page_logo' ] ) ) {
			$posted[ 'page_logo' ] = '' ;
		}

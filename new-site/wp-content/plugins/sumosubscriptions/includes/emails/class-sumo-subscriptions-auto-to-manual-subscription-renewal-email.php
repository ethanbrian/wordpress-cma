...
class SUMOSubscriptions_Auto_To_Manual_Subscription_Renewal_Email extends SUMO_Abstract_Subscription_Email {
	...
	public function __construct() {
		...
		$this->description    = addslashes( __( 'Automatic Subscription Renewal to Manual Subscription Renewal emails will be sent when the Subscription System is unable to charge for Subscription renewal within Suspend status and Subscription is changed to Manual payment mode.', 'sumosubscriptions' ) ) ;

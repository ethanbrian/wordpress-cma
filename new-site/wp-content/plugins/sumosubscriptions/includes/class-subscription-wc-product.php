...
class SUMO_Subscription_WC_Product {
	...
	public function get_formatted_name() {
		...
		/* translators: 1: product identifier 2: product title 3: product data  */
		return sprintf( __( '%1$s &ndash; %2$s%3$s', 'woocommerce' ), $identifier, $this->product->get_title(), $extra_data ) ;
	}

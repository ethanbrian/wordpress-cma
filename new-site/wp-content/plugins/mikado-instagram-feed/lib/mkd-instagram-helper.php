...
/**
 * Class MkdInstagramHelper
 */
class MkdInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines mkd_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('libero_mikado_instagram_image_atts',
            array(
                'class' => $imageSize,

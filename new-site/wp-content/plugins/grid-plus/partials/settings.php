        ...
        <ul class="nav-tabs">
            <li class="tab-current">
                <a href="javascript:;" data-section-id='layout-config'>
                    ...
                    <span><?php esc_html_e('Grid Config', 'grid-plus'); ?></span>
                </a>
            </li>
            <li>
            ...
            <li data-depend-control="layout_type" data-depend-value="carousel">
                <a href="javascript:;" data-section-id='carousel'>
                    ...
                    <span><?php esc_html_e('Carousel option', 'grid-plus'); ?></span>
                </a>
            </li>
            <li data-depend-control="layout_type" data-depend-value="grid,masonry,metro,justified">
            ...
            <li>
                <a href="javascript:;" data-section-id='skin-config'>
                    ...
                    <span><?php esc_html_e('Skin option', 'grid-plus'); ?></span>
                </a>
            </li>
            <li>

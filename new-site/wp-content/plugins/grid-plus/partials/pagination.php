...
$page_prev_text = isset($grid['grid_config']['page_prev_text']) ? $grid['grid_config']['page_prev_text'] : esc_html__('Previous','grid-plus');
$page_loadmore_text = isset($grid['grid_config']['page_loadmore_text']) ? $grid['grid_config']['page_loadmore_text'] : esc_html__('Load more','grid-plus');
...
<div class="grid-plus-container">
    ...
    <div class="form-groups" id="form_layout_pagination">
        <div class="col-md-6">
            <div class="form-group" data-depend-control="layout_type" data-depend-value="grid,masonry">
            ...
            <div class="form-group" data-depend-control="layout_type" data-depend-value="grid,masonry,carousel,justified">
            ...
            <div class="form-group" data-depend-control="layout_type" data-depend-value="metro">
                <label for="metro_layout_pagination_type" class="col-xs-4 control-label"><?php esc_html_e('Pagination type', 'grid-plus'); ?></label>
                <div class="col-xs-8">
                    <?php $pagination_type = $pagination_type == 'show_all' ? 'pagination' : $pagination_type; ?>
                    <select id="metro_layout_pagination_type" class="form-control" data-selected="<?php echo esc_attr($pagination_type); ?>" >
                        <option value="pagination" selected><?php esc_html_e('Page Numbers', 'grid-plus'); ?></option>
                        <option value="load-more"><?php esc_html_e('Load more button', 'grid-plus'); ?></option>
                        <option value="infinite-scroll"><?php esc_html_e('Infinite scroll', 'grid-plus'); ?></option>
                    </select>
                </div>
                <div class="form-group" data-depend-control="metro_layout_pagination_type" data-depend-value="pagination,load-more,infinite-scroll">
                    <label for="metro_layout_item_per_page" class="control-label col-xs-4"><?php esc_html_e('Item per page', 'grid-plus'); ?></label>
                    <div class=" col-xs-8">
                        <input type="number" class="form-control" min="1" required value="<?php echo esc_attr($item_per_page); ?>" id="metro_layout_item_per_page">
                    </div>
                </div>
                <div class="form-group" data-depend-control="metro_layout_pagination_type" data-depend-value="pagination,load-more,infinite-scroll">
                    <label for="metro_layout_total_items" class="control-label col-xs-4"><?php esc_html_e('Total items', 'grid-plus'); ?></label>
                    <div class="col-xs-8">
                        <input type="number" class="form-control" min="0" value="<?php echo esc_attr($total_item); ?>" id="metro_layout_total_items">
                        <span
                            class="description"><?php esc_html_e('Set empty for display all', 'grid-plus'); ?></span>
                    </div>
                </div>
                <div class="form-group" data-depend-control="metro_layout_pagination_type" data-depend-value="pagination">
                    <label for="metro_layout_page_prev_text" class="col-xs-4 control-label"><?php esc_html_e('Prev text', 'grid-plus'); ?></label>
                    <div class="col-xs-8">
                        <input type="text" id="metro_layout_page_prev_text" value="<?php echo esc_attr($page_prev_text); ?>">
                    </div>
                </div>
                <div class="form-group" data-depend-control="metro_layout_pagination_type" data-depend-value="pagination">
                    <label for="metro_layout_page_next_text" class="col-xs-4 control-label"><?php esc_html_e('Next text', 'grid-plus'); ?></label>
                    <div class="col-xs-8">
                        <input type="text" id="metro_layout_page_next_text" value="<?php echo esc_attr($page_next_text); ?>">
                    </div>
                </div>
                <div class="form-group" data-depend-control="metro_layout_pagination_type" data-depend-value="load-more">
                    <label for="metro_layout_page_loadmore_text" class="col-xs-4 control-label"><?php esc_html_e('Load more text', 'grid-plus'); ?></label>
                    <div class="col-xs-8">
                        <input type="text" id="metro_layout_page_loadmore_text" value="<?php echo esc_attr($page_loadmore_text); ?>">
                    </div>
                </div>
            </div>
        </div>

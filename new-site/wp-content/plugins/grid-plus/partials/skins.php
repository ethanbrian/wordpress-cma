...
$args = array(
    ...
    'img_origin' => G5PLUS_GRID_URL . 'assets/images/sample-03.jpg',
        ...
        <div class="grid-plus-layout" id="list_skins">
            <ul class="list-skins">
                <?php foreach ($grid_plus_skins as $skin) {
                    $skin_css = isset($skin['skin_css']) ? $skin['skin_css'] : (isset($skin['admin_skin_css']) ? $skin['admin_skin_css'] : '');
                    if(!empty($skin_css)){
                        wp_enqueue_style($skin['slug'], $skin_css);
                        $skin_css = 'data-skin-css="'.$skin_css.'"';
                    }

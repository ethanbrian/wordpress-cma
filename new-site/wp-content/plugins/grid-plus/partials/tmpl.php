...
<script type="text/html" id="tmpl-bg-prompt-change-item-height-dialog">
    <div class="bg-popup-change-item-height">
        <div class="content-popup">
            <a href="javascript:;" class="close-popup"><i class="fa fa-times"></i></a>
            <div>
                <label><?php echo esc_attr('Width','grid-plus'); ?></label>
            ...
            <div>
                <a href="javascript:;" class="apply-change-item-height">Apply change</a>
            </div>
        </div>
    </div>
</script>

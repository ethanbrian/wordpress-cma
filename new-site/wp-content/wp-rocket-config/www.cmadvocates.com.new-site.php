...
$rocket_cookie_hash = 'e8acfd925fdbdb98d1e653ed57b67517';
$rocket_logged_in_cookie = 'wordpress_logged_in_e8acfd925fdbdb98d1e653ed57b67517';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/new-site(/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/(index\.php/)?wp\-json(/.*|$)|/new-site/checkout/(.*)|/new-site/cart/|/new-site/my-account/(.*)|/new-site/wc-api/v(.*))';
...
$rocket_secret_cache_key = '60b7635066ebe143107997';
$rocket_cache_ssl = 1;

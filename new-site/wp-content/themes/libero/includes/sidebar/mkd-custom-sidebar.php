...
if( ! class_exists('LiberoSidebar') ){
	...
	class LiberoSidebar{
		...
		function load_assets(){
			...
			wp_enqueue_script('libero-mikado-sidebar' , MIKADO_ROOT . '/framework/admin/assets/js/mkd-sidebar.js');
			wp_enqueue_style( 'libero-mikado-sidebar' , MIKADO_ROOT . '/framework/admin/assets/css/mkd-sidebar.css');
		}
